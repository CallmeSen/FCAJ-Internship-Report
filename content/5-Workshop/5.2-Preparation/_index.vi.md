...
<figure style="text-align: center;">
    <img src="/FCAJ-Internship-Report/images/5-Workshop/5.2-Prerequisite/project-structure.png" alt="Project Structure" width="35%">
...
<figure style="text-align: center;">
    <img src="/FCAJ-Internship-Report/images/5-Workshop/5.2-Prerequisite/aws-version.png" alt="AWS CLI Version" width="80%">
    <figcaption style="text-align: center;">
...
<figure style="text-align: center;">
    <img src="/FCAJ-Internship-Report/images/5-Workshop/5.2-Prerequisite/aws-configure.png" alt="AWS Configure" width="80%">
    <figcaption style="text-align: center;">
...
<figure style="text-align: center;">
    <img src="/FCAJ-Internship-Report/images/5-Workshop/5.3-Infrastructure/terraform-version.png" alt="Terraform Version" width="60%">
    <figcaption style="text-align: center;">
