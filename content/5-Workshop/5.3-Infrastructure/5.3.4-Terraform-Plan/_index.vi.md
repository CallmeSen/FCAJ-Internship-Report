...
<figure style="text-align: center;">
    <img src="/FCAJ-Internship-Report/images/5-Workshop/5.3-Infrastructure/terraform-plan-no-changes.png" alt="Terraform Plan không phát hiện thay đổi" width="80%">
